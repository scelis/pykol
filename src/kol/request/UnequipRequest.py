...
class UnequipRequest(GenericRequest):
	"Unequips the equipment in the designated slot.  HAT, WEAPON, OFFHAND, SHIRT, PANTS, SLOT1, SLOT2, SLOT3, and FAMILIAR may be used to de-equip certain things, or ALL will de-equip everything."
